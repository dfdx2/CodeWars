/* 8KYU CodeWars A Strange Trip To The Market
...
monster, the time has come to code a solution for finding The Loch Ness Monster. 
...
public class Nessie {
    public static boolean isLockNessMonster(String s){
     //FIND THE LOCH NESS MONSTER. SAVE YOUR TREE FIDDY
      ...
      else if (s.contains("three fifty")) {
        return true;
      }
      return false;
    }
...
public class Nessie {
    public static boolean isLockNessMonster(String s){
     return s.contains("tree fiddy") || s.contains("3.50") ? true:false;
    }
}
