/* 8KYU CodeWars Determine Offspring Sex Based On Genes XX and XY 

The male gametes or sperm cells in humans and other mammals are 
heterogametic and contain one of two types of sex chromosomes. 
They are either X or Y. The female gametes or eggs however, contain 
only the X sex chromosome and are homogametic.
...
resulting zygote will be XX or female. If the sperm cell contains 
...
public class Kata {
  ...
  public static String chromosomeCheck(String sperm) {
    String child = sperm.equals("XY") ? "son" : "daughter";
