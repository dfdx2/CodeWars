/* 8KYU CodeWars OOP: Object Oriented Piracy
...
Unfortunately for you, people weigh a lot these days, so how do you know if a ship is full 
of gold and not people?
...
public class Ship {
  ...
  public boolean isWorthIt(){
    return ((double) draft - (crew*1.5) > 20) ? true : false;
  }
} 
